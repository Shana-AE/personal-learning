...
me: abstract methods can only appear within an abstract class
...
me: the last one ,`department.generateReports()` shows that derived class must match the structure of the abstract class
...
me: this maybe why interface static methods should be initialize by `let xxx: Xxx`
